    ...
    , ui(new Ui::MainWindow)
{
    ...
    QLayout* parentLayout = ui->graphicsPlaceholder->parentWidget()->layout();
    parentLayout->replaceWidget(ui->graphicsPlaceholder, graphics_viewer);
    delete ui->graphicsPlaceholder;
